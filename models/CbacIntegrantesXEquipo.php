...
/**
 * This is the model class for table "cbac.integrantes_x_equipo".
 *
 * @property string $id
 ...
 */
class CbacIntegrantesXEquipo extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'cbac.integrantes_x_equipo';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['id_equipo_campo'], 'exist', 'skipOnError' => true, 'targetClass' => CbacEquiposCampo::className(), 'targetAttribute' => ['id_equipo_campo' => 'id']],
