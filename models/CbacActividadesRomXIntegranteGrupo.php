...
/**
 * This is the model class for table "cbac.actividades_rom_x_integrante_grupo".
 *
 * @property int $id
 ...
 */
class CbacActividadesRomXIntegranteGrupo extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'cbac.actividades_rom_x_integrante_grupo';
    }
