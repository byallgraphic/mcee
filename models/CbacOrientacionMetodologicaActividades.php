...
/**
 * This is the model class for table "cbac.orientacion_metodologica_actividades".
 *
 * @property string $id
 ...
 */
class CbacOrientacionMetodologicaActividades extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'cbac.orientacion_metodologica_actividades';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['id_actividades'], 'exist', 'skipOnError' => true, 'targetClass' => CbacRomActividades::className(), 'targetAttribute' => ['id_actividades' => 'id']],
        ];
    }
