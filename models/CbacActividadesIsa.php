...
/**
 * This is the model class for table "cbac.actividades_isa".
 *
 * @property int $id
 ...
 */
class CbacActividadesIsa extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['id_iniciacion_sencibilizacion_artistica'], 'exist', 'skipOnError' => true, 'targetClass' => CbacIniciacionSencibilizacionArtistica::className(), 'targetAttribute' => ['id_iniciacion_sencibilizacion_artistica' => 'id']],
            [['id_procesos_generales'], 'exist', 'skipOnError' => true, 'targetClass' => CbacProcesosGenerales::className(), 'targetAttribute' => ['id_procesos_generales' => 'id']],
