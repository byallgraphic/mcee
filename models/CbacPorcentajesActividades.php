...
/**
 * This is the model class for table "cbac.porcentajes_actividades".
 *
 * @property string $id
 ...
 */
class CbacPorcentajesActividades extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'cbac.porcentajes_actividades';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['id_rom_actividades'], 'exist', 'skipOnError' => true, 'targetClass' => CbacRomActividades::className(), 'targetAttribute' => ['id_rom_actividades' => 'id']],
            [['id_seguimiento_proceso'], 'exist', 'skipOnError' => true, 'targetClass' => CbacSeguimientoProceso::className(), 'targetAttribute' => ['id_seguimiento_proceso' => 'id']],
        ];
    }
