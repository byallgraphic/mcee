...
<table id='tb'>
	<thead>
		<tr style='background-color:#ccc;text-align:center;'>
			...
			<th colspan='<?= 9 + $max2 ?>' style='border: 1px solid black;'>Fase II Desarrollo e implementaci&oacute;n</th>
			<th colspan='<?= 3 + $max3 ?>' style='border: 1px solid black;'>Fase III  (Uso - Aplicaci&oacute;n)</th>
	...
	<tbody>
		<?php
			foreach ($data as $key => $value) {
				?>
					<tr>
                        <?php for ($i=0;$i<(27+$max1+$max2+$max3);$i++){?>
