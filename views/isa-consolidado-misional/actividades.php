...
use app\models\IsaActividadesConsolidadoMisional;
...
$actividadesConsolidado = IsaActividadesConsolidadoMisional::find()->where( "estado=1 and id_rom_procesos=$idProceso" )->all();
