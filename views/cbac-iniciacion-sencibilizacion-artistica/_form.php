...
$this->registerJs( file_get_contents( '../web/js/sensibilizacionCbac.js' ) );
...
?>
	<script>
		...
		{
			$.get( "index.php?r=cbac-iniciacion-sencibilizacion-artistica/requerimientos&id="+id,
						function( data )
						{
							$.each(data, function( index, value ) 
							{
								...
								selectActividad = $("#cbacactividadesisa-"+index+"-requerimientos_tecnicos");
		...
		{
			$.get( "index.php?r=cbac-iniciacion-sencibilizacion-artistica/requerimientos-logisticos&id="+id,
						function( data )
						{
							$.each(data, function( index, datos ) 
							{
								...
								selectActividad = $("#cbacactividadesisa-"+idActividad+"-requerimientos_logisticos");
